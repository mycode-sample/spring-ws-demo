 ...
 * 
 */
@WebServiceClient(name = "HumanResourceService", targetNamespace = "http://mycompany.com/hr/schemas", wsdlLocation = "http://localhost:8080/spring-ws-demo/holidayService/holiday.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HUMANRESOURCESERVICE_QNAME = new QName("http://mycompany.com/hr/schemas", "HumanResourceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/spring-ws-demo/holidayService/holiday.wsdl");
